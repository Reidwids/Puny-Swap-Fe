			...
			<div className="circle-tile">
				<div className="circle-tile-heading">
					<div className="circle-tile-image-cont">
						<img className="circle-tile-image" id="card_image" src={props.data.iconUrl} alt="coin" onClick={(e) => props.populateChart(e, props.data.symbol, props.data.name, '24h')}></img>
					</div>
				</div>
				<div className="circle-tile-content">
					...
					{bookmarked ? (
						...
						<div className="circle-tile-footer" onClick={(e) => addToFavorites(e, props.data.symbol)}>
							Fav <img src={favSvgBdr} id="fav" alt="favorite" />
						</div>
					)}
				</div>
			</div>
