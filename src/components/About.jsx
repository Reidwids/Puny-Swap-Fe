    ...
    <div className='content-section' id='about'>
      ...
      <div className='right'>
        <div>
          ...
          <Container>
              <Form.Group>
                  <Form.Control required name='addressTo' placeholder='Address To' onChange={handleChange}></Form.Control>
              </Form.Group>
              <Form.Group>
                  <Form.Control required name='amount' placeholder='Amount (Eth)'onChange={handleChange}></Form.Control>
              </Form.Group>
              <Form.Group>
                  <Form.Control required name='keyword' placeholder='Keyword (Gif)'onChange={handleChange}></Form.Control>
              </Form.Group>
              <Form.Group>
                  <Form.Control required name='message' placeholder='Message' onChange={handleChange}></Form.Control>
              </Form.Group>
              <Button varient='primary' onClick={handleSubmit}>Send Now</Button>
          </Container>
